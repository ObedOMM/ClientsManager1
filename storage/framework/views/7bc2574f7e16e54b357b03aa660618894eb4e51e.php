...
unset($__errorArgs, $__bag); ?>" name="name" placeholder="Rentrez un name..." value="<?php echo e(old('name') ?? $client->name); ?>">
...
unset($__errorArgs, $__bag); ?>" name="email" placeholder="Rentrez un email..." value="<?php echo e(old('email') ?? $client->email); ?>">
...
<div class="form-group">
    <select name="status" id="" class="custom-select <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<div class="form-group">
    <select name="entreprise_id" id="" class="custom-select <?php $__errorArgs = ['entreprise_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
    <div class="invalid-feedback">
        <?php echo e($errors->first('entreprise_id')); ?>
...
<?php /**PATH C:\laragon\www\monapp\resources\views/includes/form.blade.php ENDPATH**/ ?>